  ...
  return (
    <header className='fixed top-0 left-0 -z-50 w-full py-10'>
      <div className='container flex h-14 items-center max-lg:px-5'>
        ...
        >
          <div className='border-2 border-amber-400 max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4'>
